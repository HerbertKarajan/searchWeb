...
Ext.onReady(function () {
	...
	Ext.BLANK_IMAGE_URL = 'http://www.bejson.com/static/bejson/jsonview/ico1/s.gif';
	Ext.QuickTips.init();
    ...
    var tree = {
        ...
        bbar: [
	        ...
	        new Ext.form.Label({
	        	...
	        	iconCls: Ext.ux.iconCls.get('http://www.bejson.com/static/bejson/jsonview/ico1/arrow_down.png'),
	        	text: 'Next',
	        	handler: function () {
	        		jsonviewer.searchNext();
	        	}
	        }, {
	        	iconCls: Ext.ux.iconCls.get('http://www.bejson.com/static/bejson/jsonview/ico1/arrow_up.png'),
	        	text: 'Previous',
	        	handler: function () {
	...
	var jsonviewer = function () {
		...
		return {
			...
			treebuild: function () {
				...
				root.setIcon(Ext.isArray(json) ? 'http://www.bejson.com/static/bejson/jsonview/ico1/array.gif' : 'http://www.bejson.com/static/bejson/jsonview/ico1/object.gif');
				this.gridbuild(root);
			},
			...
			json2leaf: function (json) {
				...
				for (var i in json) {
					if (json.hasOwnProperty(i)) {
						if (json[i] === null) {
							ret.push({text: i + ' : null', leaf: true, icon: 'http://www.bejson.com/static/bejson/jsonview/ico1/red.gif'});
						} else if (typeof json[i] === 'string') {
							ret.push({text: i + ' : "' + json[i] + '"', leaf: true, icon: 'http://www.bejson.com/static/bejson/jsonview/ico1/blue.gif'});
						} else if (typeof json[i] === 'number') {
							ret.push({text: i + ' : ' + json[i], leaf: true, icon: 'http://www.bejson.com/static/bejson/jsonview/ico1/green.gif'});
						} else if (typeof json[i] === 'boolean') {
							ret.push({text: i + ' : ' + (json[i] ? 'true' : 'false'), leaf: true, icon: 'http://www.bejson.com/static/bejson/jsonview/ico1/yellow.gif'});
						} else if (typeof json[i] === 'object') {
							ret.push({text: i, children: this.json2leaf(json[i]), icon: Ext.isArray(json[i]) ? 'http://www.bejson.com/static/bejson/jsonview/ico1/array.gif' : 'http://www.bejson.com/static/bejson/jsonview/ico1/object.gif'});
						} else if (typeof json[i] === 'function') {
							ret.push({text: i + ' : function', leaf: true, icon: 'http://www.bejson.com/static/bejson/jsonview/ico1/red.gif'});
						}
					}
				}
				return ret;
